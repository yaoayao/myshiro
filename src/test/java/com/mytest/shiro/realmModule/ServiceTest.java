...
import com.mytest.shiro.realmModule.service.*;
...
/**
 * Created by miyan(弥彦) on 2017/3/2 15:30.
 */
public class ServiceTest {
    ...
    public void setUp() {
        ...
        //2、新增角色
        r1 = new Role("admin", "admin", Boolean.TRUE);
        r2 = new Role("user", "user admin", Boolean.TRUE);
